export const it = {
  // Import structure from English with Italian translations
  // App Navigation
  navigation: {
    home: 'Casa',
    saved: 'Salvati',
  ...
  home: {
    ...
    features: {
      multiLanguage: {
        title: 'Multi-Lingua',
        description: '10+ lingue supportate',
      },
      locationSmart: {
        title: 'Intelligente di Posizione',
        description: 'Scoperte consapevoli del contesto',
      },
      saveAndShare: {
        title: 'Salva e Condividi',
        description: 'Costruisci il tuo diario di viaggio',
      },
      aiGuide: {
        title: 'Guida IA',
        description: 'Intuizioni storiche istantanee',
      },
    },
  },
  ...
  // Review Modal
  review: {
    title: 'Ti piace LandmarkAI?',
    message: 'Se ami scoprire luoghi storici con la nostra IA, per favore considera di valutarci sull\'App Store!',
    rateNow: 'Valuta Ora',
